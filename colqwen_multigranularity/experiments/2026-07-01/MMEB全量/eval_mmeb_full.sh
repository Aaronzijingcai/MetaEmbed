...
MAXSIM_ADAPTIVE_RATIO=${MAXSIM_ADAPTIVE_RATIO:-1.5}
...

{
  ...
  echo "[mmeb_full_eval] MAXSIM_QUERY_AGG=$MAXSIM_QUERY_AGG MAXSIM_QUERY_TOPK=$MAXSIM_QUERY_TOPK MAXSIM_ADAPTIVE_RATIO=$MAXSIM_ADAPTIVE_RATIO MAXSIM_LENGTH_NORM_ALPHA=$MAXSIM_LENGTH_NORM_ALPHA"
