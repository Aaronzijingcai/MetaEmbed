...
RUN_NAME=${RUN_NAME:-folder_homo_mmeb_full_train_b160_160_160_4k}
...
INTERACTION_ADAPTIVE_RATIO=${INTERACTION_ADAPTIVE_RATIO:-1.5}
...
EXTRA_ARGS=(
  ...
  --interaction-adaptive-ratio "$INTERACTION_ADAPTIVE_RATIO"
)
...

{
  ...
  echo "[mmeb_full_train] BUDGETS=${BUDGETS[*]} COMPRESS_STAGES=$COMPRESS_STAGES MARC_ENABLED=$MARC_ENABLED"
  echo "[mmeb_full_train] INTERACTION_LOSS_MODE=$INTERACTION_LOSS_MODE INTERACTION_BI_LAMBDA=$INTERACTION_BI_LAMBDA INTERACTION_GLOBAL_WEIGHT=$INTERACTION_GLOBAL_WEIGHT INTERACTION_FACTORIZED_LOCAL_WEIGHT=$INTERACTION_FACTORIZED_LOCAL_WEIGHT INTERACTION_GLOBAL_AUX_WEIGHT=$INTERACTION_GLOBAL_AUX_WEIGHT INTERACTION_QUERY_TOPK=$INTERACTION_QUERY_TOPK INTERACTION_ADAPTIVE_RATIO=$INTERACTION_ADAPTIVE_RATIO"
} >> "$LOG_FILE"
