...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        choices=['strategy1_softassign', 'strategy2_softpool', 'strategy3_prumerge', 'strategy4_visionzip', 'strategy5_folder', 'strategy6_scope', 'strategy4s_scopevisionzip', 'strategy3s_scopeprumerge', 'strategy7_stage_resampler', 'strategy7m_prefix_resampler'],
    )
