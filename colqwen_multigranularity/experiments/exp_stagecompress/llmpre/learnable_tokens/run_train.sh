...
RUN_NAME=${RUN_NAME:-global_mrl_tokens_8gpu_nommE5_textquery_focus_4k}
...
{
  echo "[launcher] $(date +%Y-%m-%d\ %H:%M:%S) starting GlobalMRLToken training"
  ...
  echo "[launcher] QUERY_TOKENS=$NUM_QUERY_MRL_TOKENS DOC_TOKENS=$NUM_DOC_MRL_TOKENS MRL_GROUPS=$MRL_GROUPS"
...
"$ACCELERATE_BIN" launch \
  ...
  -m colqwen_multigranularity.experiments.exp_stagecompress.llmpre.learnable_tokens.train_global_mrl_tokens \
