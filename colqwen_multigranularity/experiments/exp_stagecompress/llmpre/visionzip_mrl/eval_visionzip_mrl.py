...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--visionzip-mode", type=str, choices=["mask", "prune"], default="prune")
...
def build_model(args: argparse.Namespace):
    ...
    if state_path is None and args.adapter_path is not None:
        candidate = Path(args.adapter_path) / "visionzip_mrl_selector.pt"
        if candidate.exists():
    ...
    return build_visionzip_mrl_model(
        ...
        visionzip_mrl_state_path=state_path,
        eval_mode=True,
        ...
        visionzip_keep_ratios=_parse_keep_ratios(args.visionzip_keep_ratios),
