...
from colqwen_multigranularity.experiments.exp_stagecompress.llmpre.twigmrl.modeling_twigmrl import build_twigmrl_model
...
def build_model(args: argparse.Namespace):
    ...
    if state_path is None and args.adapter_path is not None:
        candidate = Path(args.adapter_path) / "twigmrl_selector.pt"
        if candidate.exists():
