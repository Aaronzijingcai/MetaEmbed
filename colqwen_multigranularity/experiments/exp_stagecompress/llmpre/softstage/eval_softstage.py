...
from .modeling_softstage import build_softstage_model, load_softstage_state
from .train_softstage import _parse_keep_ratios
...
def build_model(args: argparse.Namespace):
    ...
    if state_path is None and args.adapter_path is not None:
        candidate = Path(args.adapter_path) / "softstage_selector.pt"
        if candidate.exists():
    ...
    model = build_softstage_model(
        ...
        softstage_state_path=state_path,
        eval_mode=True,
