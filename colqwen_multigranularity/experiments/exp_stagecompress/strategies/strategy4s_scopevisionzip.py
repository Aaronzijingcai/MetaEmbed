...
class Strategy4SScopeVisionZipBlock(BaseStrategyBlock):
    strategy_name = "strategy4s_scopevisionzip"
    ...
    def __init__(self, embed_dim: int, budget: int, *, tau: float, scorer_heads: int, scorer_dropout: float, use_text_context: bool):
        ...
        self.visionzip_dominant_ratio = 0.9
        self.visionzip_contextual_ratio = 0.1
    ...
    def forward(self, tokens, text_context=None):
        ...
        return self._forward_scope_visionzip_impl(tokens=tokens, enhanced=enhanced, saliency=saliency)
