...
# Crop-first VisionZip checkpoint trained with Qwen2.5-VL visual attention saliency.
# The checkpoint config is loaded from CHECKPOINT/strategy2_visionzip_config.json.
DEFAULT_CHECKPOINT="$PROJECT_DIR/runs/strategy2_visionzip_crop_visualattn_l-2_b64-128-256_20260530_173958"
