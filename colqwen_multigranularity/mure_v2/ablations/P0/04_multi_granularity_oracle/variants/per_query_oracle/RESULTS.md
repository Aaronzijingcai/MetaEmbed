# Experiment Results: per_query_oracle
...
| Field | Value |
|---|---|
| Suite | multi_granularity_oracle |
| Variant | per_query_oracle |
| Priority | P0 |
| Status | eval_only |
| Backend | oracle |
| Purpose | Ground-truth per-query upper bound over g1, g2, and g3. |
| Experiment config | mure_v2/ablations/P0/04_multi_granularity_oracle/experiment.json |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `per_query_oracle` | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] |
