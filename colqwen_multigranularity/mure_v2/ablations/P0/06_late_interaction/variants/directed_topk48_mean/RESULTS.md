# Experiment Results: directed_topk48_mean
...
| Variant | directed_topk48_mean |
| Priority | P0 |
| Status | ready |
| Backend | rhc |
| Purpose | Directed TopK-mean over the strongest 48 query-side matches. |
| Experiment config | mure_v2/ablations/P0/06_late_interaction/experiment.json |
| MaxSim formulation | Directed Top-K MaxSim with mean aggregation |
...
| Interaction mode | q2d_query_topk (Directed Top-K MaxSim with mean aggregation) |
...
| `INTERACTION_LOSS_MODE` | q2d_query_topk |
| `INTERACTION_QUERY_TOPK` | 48 |
| `INTERLEAVED_BSZ` | 8 |
| `LEARNING_RATE` | 0.0001 |
| `LOGGING_STEPS` | 10 |
| `LR_SCHEDULER_TYPE` | linear |
| `MAIN_PROCESS_PORT` | 29841 |
| `MARC_ENABLED` | 0 |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `directed_topk48_mean` | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] |
