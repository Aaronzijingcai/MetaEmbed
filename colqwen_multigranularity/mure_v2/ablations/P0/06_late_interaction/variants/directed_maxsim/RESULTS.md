# Experiment Results: directed_maxsim
...
| Variant | directed_maxsim |
| Priority | P0 |
| Status | ready |
| Backend | rhc |
| Purpose | Standard directed MaxSim using query-to-candidate sum aggregation. |
| Experiment config | mure_v2/ablations/P0/06_late_interaction/experiment.json |
| MaxSim formulation | Standard directed MaxSim (query-to-candidate sum) |
...
| Per-stage token budgets | 128 128 128 |
| MRL loss weights | 1 1 1 |
| Importance weight (alpha) | 1.0 |
| Gain weight (beta) | 1.0 |
| Value-modulation strength | 0.25 |
| Interaction mode | q2d_sum (Standard directed MaxSim (query-to-candidate sum)) |
| Interaction Top-K | 48 |
| Bidirectional lambda cap | 0.5 |
...
| `GRAD_ACCUM_STEPS` | 1 |
| `GRANULARITY_LOSS_WEIGHTS` | 1 1 1 |
| `IGNORE_DATA_SKIP` | 0 |
...
| `INTERACTION_LOSS_MODE` | q2d_sum |
| `INTERACTION_QUERY_TOPK` | 48 |
| `INTERLEAVED_BSZ` | 8 |
| `LEARNING_RATE` | 0.0001 |
| `LOGGING_STEPS` | 10 |
| `LR_SCHEDULER_TYPE` | linear |
| `MAIN_PROCESS_PORT` | 29840 |
| `MARC_ENABLED` | 0 |
...
- Training status: running (`2316/60000` at 2026-07-23 17:26 CST)
- Evaluation status: pending training checkpoint selection
- Run directory: `/MURE-V2/code/MetaEmbed/colqwen_multigranularity/experiments/2026-07-08/runs/rhc_mmeb_vidore_q2d_sum_from_base_formal_standard_maxsim_60k_bsz8_b128_20260722_0128`
- Selected checkpoint: `[TODO; latest complete checkpoint is checkpoint-2000]`
- Training log: `/MURE-V2/code/MetaEmbed/colqwen_multigranularity/experiments/2026-07-08/runs/rhc_mmeb_vidore_q2d_sum_from_base_formal_standard_maxsim_60k_bsz8_b128_20260722_0128/logs/train_20260722_012958.log`
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `directed_maxsim` | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] |
