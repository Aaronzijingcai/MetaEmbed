...
| Status | ready |
| Backend | rhc |
| Purpose | Global and fine views under a matched total budget. |
...
| Per-stage token budgets | 192 0 192 |
| MRL loss weights | 1 0 1 |
...
| `GRAD_ACCUM_STEPS` | 1 |
| `GRANULARITY_LOSS_WEIGHTS` | 1 0 1 |
| `IGNORE_DATA_SKIP` | 0 |
| `INCLUDED_STAGES` | g1+g3 |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `g1_g3` | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] |
