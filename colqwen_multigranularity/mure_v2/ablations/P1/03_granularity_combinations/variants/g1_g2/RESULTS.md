...
| Status | ready |
| Backend | rhc |
| Purpose | Global and intermediate views under a matched total budget. |
...
| Per-stage token budgets | 192 192 0 |
| MRL loss weights | 1 1 0 |
...
| `GRAD_ACCUM_STEPS` | 1 |
| `GRANULARITY_LOSS_WEIGHTS` | 1 1 0 |
| `IGNORE_DATA_SKIP` | 0 |
| `INCLUDED_STAGES` | g1+g2 |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `g1_g2` | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] |
