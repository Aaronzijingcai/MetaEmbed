...
class CorpusQueryCollator(VisualRetrieverCollator):
    ...
    def __init__(
        ...
        if self.corpus_format == "wikiss":
            ...
            self.docid_to_idx = {
                docid: idx for idx, docid in enumerate(self.image_dataset["docid"])
            }
    ...
    def get_image_from_docid(self, docid: str) -> Image.Image:
        ...
        if self.corpus_format == "wikiss":
            ...
            raise NotImplementedError(
                f"Corpus format {self.corpus_format} not supported"
            )
    ...
    def __call__(self, examples: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        for example in examples:
            ...
            if self.mined_negatives:
                ...
                chosen_negative = negative_candidates[
                    randint(0, len(negative_candidates) - 1)
                ]
                if self.corpus_format in {"wikiss", "docmatix"}:
