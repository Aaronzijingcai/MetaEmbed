...
class Strategy4VisionZipBlock(BaseStrategyBlock):
    strategy_name = "strategy4_visionzip"
    ...
    def forward(self, tokens, text_context=None):
        ...
        return self._forward_visionzip_impl(tokens=tokens, enhanced=enhanced, saliency=saliency)
