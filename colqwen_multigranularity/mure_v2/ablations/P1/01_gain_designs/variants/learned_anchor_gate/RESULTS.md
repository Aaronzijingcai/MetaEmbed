# Experiment Results: learned_anchor_gate
...
|---|---|
| Suite | gain_designs |
| Variant | learned_anchor_gate |
| Priority | P1 |
| Status | ready |
| Backend | gain_design |
| Purpose | Learned cross-anchor gate from the archived gain exploration. |
...
|---|---|
| `ABLATION_KIND` | gain |
| `ABLATION_MODE` | learned_anchor_gate |
| `BUDGETS` | 128 128 128 |
| `COMPRESS_STAGES` | all |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `learned_anchor_gate` | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] |
