# Experiment Results: learned_metric_residual
...
|---|---|
| Suite | gain_designs |
| Variant | learned_metric_residual |
| Priority | P1 |
| Status | ready |
| Backend | gain_design |
| Purpose | Learned metric residual from the archived gain exploration. |
| Experiment config | mure_v2/ablations/P1/01_gain_designs/experiment.json |
...
|---|---|
| `ABLATION_KIND` | gain |
| `ABLATION_MODE` | learned_metric_residual |
| `BUDGETS` | 128 128 128 |
| `COMPRESS_STAGES` | all |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `learned_metric_residual` | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] |
