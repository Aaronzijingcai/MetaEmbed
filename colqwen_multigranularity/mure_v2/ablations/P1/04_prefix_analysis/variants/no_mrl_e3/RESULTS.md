...
| Priority | P1 |
| Status | eval_only |
| Backend | prefix_evaluation |
| Purpose | Complete prefix from the final-prefix-only model. |
| Experiment config | mure_v2/ablations/P1/04_prefix_analysis/experiment.json |
...
| `RUN_EVAL` | 0 |
| `SAVE_STEPS` | 1000 |
| `SOURCE_VARIANT` | hierarchical_without_mrl |
| `STOP_AFTER_STEP` | 0 |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `no_mrl_e3` | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] |
