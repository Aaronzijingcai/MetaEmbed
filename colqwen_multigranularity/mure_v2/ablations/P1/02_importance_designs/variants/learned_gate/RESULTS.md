# Experiment Results: learned_gate
...
| Variant | learned_gate |
| Priority | P1 |
| Status | ready |
| Backend | importance_design |
| Purpose | Gate-head importance from the archived importance exploration. |
| Experiment config | mure_v2/ablations/P1/02_importance_designs/experiment.json |
...
| Variable | Value |
|---|---|
| `ABLATION_KIND` | importance |
| `ABLATION_MODE` | learned_gate |
| `BUDGETS` | 128 128 128 |
| `COMPRESS_STAGES` | all |
...
| `MURE_EXPECTED_FOLDER_HOMO_TENSORS` | 0 |
| `MURE_EXPECTED_LANGUAGE_LORA_TENSORS` | 504 |
| `MURE_EXPECTED_TRAINABLE_NUMEL` | 0 |
| `MURE_EXPECTED_TRAINABLE_TENSORS` | 0 |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `learned_gate` | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] | [TODO] |
