...
class ColQwen2_5_Processor(BaseVisualRetrieverProcessor, Qwen2VLProcessor):  # noqa: N801
    ...
    def process_images(
        self, images: List[Image.Image], context_prompts: Optional[List[str]] = None
    ) -> BatchFeature:
        """
        ...
        # Added a batch_dim to qwen-style pixel_values.
        # offsets = (
        ...
        # # Right padding does not affect how the model processes the pixel_values
